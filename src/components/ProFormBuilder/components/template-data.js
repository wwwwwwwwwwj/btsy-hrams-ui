      ...
      items: [
        ...
        },
        {
          ...
          props: {
            ...
            datasource:
              "/*__PRO_FORM__*/async ({ pages, orders }) => {\n    const res = await httpRequest.get('/system/user/list', {\n        params: Object.assign({}, pages, orders, {\n            userName: form.ft5a9dzi73asjpmg\n        })\n    });\n    return res.data;\n}",
            columns: [
              {
                type: 'index',
                columnKey: 'index',
        ...
        },
        {
          ...
          props: {
            options:
              "/*__PRO_FORM__*/async () => {\n    const res = await httpRequest.get('/system/dept/list');\n    return res.data.data.map(d => ({ label: d.deptName, value: d.deptId }));\n}\n",
            onChange:
        ...
        },
        {
          ...
          props: {
            options:
              "/*__PRO_FORM__*/async () => {\n    const res = await httpRequest.get('/system/user/list', {\n        params: { deptId: form.fxy80sbtibftdj2c }\n    });\n    return res.data.rows.map(d => ({\n        label: `${d.userName}(${d.dept?.deptName})`,\n        value: d.userId\n    }));\n}"
          },
          itemProps: {
            labelWidth: 56
          }
