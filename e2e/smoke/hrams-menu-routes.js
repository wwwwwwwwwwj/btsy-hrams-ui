...
export const HRAMS_MENU_ROUTES = [
  ...
  { title: '材料管理', path: '/archive-material', component: 'hrams/archive/material/index' },
  { title: '上传批次', path: '/archive-material-group/batch', component: 'hrams/material/batch/index' },
